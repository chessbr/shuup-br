    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_type', enumfields.fields.EnumField(verbose_name='Tipo de pessoa', default='PF', max_length=2, enum=shoop_br.models.PersonType)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cnpj', models.CharField(verbose_name='CNPJ', max_length=18, validators=[shoop_br.models.validate_cnpj])),
                ...
                ('taxation', enumfields.fields.EnumField(verbose_name='Tipo de tributação', default='e', max_length=1, enum=shoop_br.models.Taxation)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(verbose_name='CPF', max_length=14, validators=[shoop_br.models.validate_cpf])),
                ('rg', models.CharField(verbose_name='Identidade', max_length=30)),
                ('birth_date', models.DateField(verbose_name='Data de nascimento')),
                ('gender', enumfields.fields.EnumField(verbose_name='Sexo', default='u', max_length=4, enum=shoop.core.models.Gender)),
