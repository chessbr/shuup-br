...
from shuup_br.checkout.order_creator import ShuupBRBasketOrderCreator
...
from shuup.testing.factories import (
    get_address, get_default_payment_method, get_default_product, get_default_shipping_method,
...
def test_order_creator(rf):
    admin_user = get_user_model().objects.create_superuser(email='admin@admin.com', password='admin')
...
@pytest.mark.django_db
def test_order_creator_supplierless_product_line_conversion_should_fail(rf):
    admin_user = get_user_model().objects.create_superuser(email='admin@admin.com', password='admin')
...
@pytest.mark.django_db
def test_order_source_parentage(rf):
    admin_user = get_user_model().objects.create_superuser(email='admin@admin.com', password='admin')
